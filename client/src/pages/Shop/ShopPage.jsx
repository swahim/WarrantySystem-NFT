  ...
  return (
    <div className="shop-page">
      ...
      <div className="productContainer">
        <Card cost="500" productName="Product Name" image="https://media.istockphoto.com/photos/stylish-blue-headphones-on-multi-colored-duo-tone-background-lighting-picture-id1175355990?k=20&m=1175355990&s=612x612&w=0&h=LX5kcpZKWyJQA_Kh5Ub9EwDNpGtAimGr2AePNQJPYxE="/>
